<div class="content">
	<div class="page_content">
		<?php if(isset($onHome) && !empty($onHome)):?>
		<?php foreach($onHome as $s):?>
		<div class="page_box">	
			...
			<div class="info_box" <?php echo ($count%2==0?"style='clear:both'":"");?>>
				<div class="info_box_bg">					
					...
					<?php 
						switch($info['accomodation']){
							case 'summer': $lnk = "letovanja"; break;
							case 'winter': $lnk = "zimovanja"; break;
							case 'city_break': $lnk = "evropski-gradovi"; break;
							case 'other': $lnk = "specijalno"; break;
						}
					?>
						<a href="<?php echo BASE_PATH.$lnk.DS.$info['link_name'].DS; ?>">
							saznaj više
						</a>
					</div>
