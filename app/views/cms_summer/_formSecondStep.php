<table cellpadding="0" cellspacing="0" width="100%">
	...
	<tbody>
	    ...
	    <tr>
	    	...
	    	<td>
	    		<a href="<?php echo BASE_PATH.'cms'.DS.'summer'.DS.$o['id'].DS.'delete-service'.DS.'?id='.$params['id'].'&step=second'; ?>" class="j_icon j_del" rel="<?php echo $o['service']; ?>" title="Brisanje vrste usluge"><!-- delete --></a>
	    	</td>
		</tr>
		<?php endforeach; ?>
		<?php endif;?>
