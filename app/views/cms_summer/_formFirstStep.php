...
<table cellpadding="0" cellspacing="0" width="100%">
	...
	<tbody>
	    ...
	    <tr>
	    	...
	    	<td>
	    		<a href="<?php echo BASE_PATH.'cms'.DS.'summer'.DS.$params['id'].DS.'delete-image'.DS.'?img_id='.$a['id'].'&step=first'; ?>" class="j_icon j_del" rel="<?php echo $a['image']; ?>" title="Brisanje slike"><!-- delete --></a>
	    	</td>
		</tr>
		<?php endforeach; ?>
		<?php endif;?>
...
<script type="text/javascript" >
	...
	function deleteRow(id, realId){
		if(realId > 0){
			$.post('<?php echo BASE_PATH.'cms'.DS.'summer'.DS.'delete-image'.DS; ?>',
					{id: realId},
					function(data){
